package com.laboratory.modules.quartz.rest;
...
public class QuartzJobControllers {
    ...
    @RequestMapping
    public ResponseEntity<Object> findAllQuartz(Pageable pageable, String jobName, Principal principal){
        if(ObjectUtil.isNull(jobName)){
            jobName="";
        }
        PageInfo<CronInfoDto> info = quartzJobServices.getAllJob(pageable,jobName);
