...
import com.laboratory.modules.security.service.dto.OnlineUserDto;
...
public class OnlineUserService {
    ...
    public void save(JwtUserDto jwtUserDto, String token, HttpServletRequest request){
        ...
        try {
            onlineUserDto = new OnlineUserDto(jwtUserDto.getUsername(), dept, browser , ip, address, EncryptUtils.desEncrypt(token), new Date());
        } catch (Exception e) {
