...
import com.laboratory.modules.system.domain.*;
import com.laboratory.modules.system.service.mapper.*;
...
import com.laboratory.modules.system.service.*;
import com.laboratory.modules.system.service.dto.MenuDto;
import com.laboratory.modules.system.service.dto.RoleDto;
import com.laboratory.modules.system.service.dto.RoleQueryParam;
...
import com.laboratory.modules.system.service.RolesDeptsService;
...
public class RoleServiceImpl extends CommonServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    public List<GrantedAuthority> mapToGrantedAuthorities(UserDto user) {
        ...
        // 如果是管理员直接返回
        if (user.getIsAdmin()) {
            permissions.add(ElAdminConstant.ADMIN_USER);
