 ...
 */
package com.laboratory.modules.system.rest;

import cn.hutool.core.collection.CollectionUtil;
import com.laboratory.annotation.Log;
import com.laboratory.modules.system.domain.User;
import com.laboratory.modules.system.domain.vo.UserPassVo;
...
public class UserController {
    ...
    @GetMapping("/all")
    @PreAuthorize("@el.check('user:list')")
    public ResponseEntity<Object> queryAll(UserQueryParam criteria){
