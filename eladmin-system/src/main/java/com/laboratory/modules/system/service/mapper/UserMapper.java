...
public interface UserMapper extends CommonMapper<User> {
     ...
     */
    @Results({
            @Result(column = "dept_id", property = "dept", one = @One(select = "com.laboratory.modules.system.service.mapper.DeptMapper.selectLink")),
            @Result(column = "job_id", property = "job", one = @One(select = "com.laboratory.modules.system.service.mapper.JobMapper.selectLink")), })
